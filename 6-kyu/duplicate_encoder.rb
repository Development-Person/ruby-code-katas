...
def duplicate_encode1(word)
  ...
  chars_array.map { |element| chars_array.count(element) > 1 ? ')' : '(' }.join
end

p duplicate_encode1('din') # "((("
puts duplicate_encode1('recede') # "()()()"
p duplicate_encode1('Success') # ")())())","should ignore case"
p duplicate_encode1('(( @') # "))(("
